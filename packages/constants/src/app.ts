...
export const companyName = 'Kevon Kibochi';
export const appName = companyName;
export const companyOneLiner = sample.text.sentence;
export const companyDescription = sample.text.prose;
